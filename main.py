...
#     st.set_page_config(
#         page_icon="🏋️‍♀️",
#         page_title="Your Personal AI GYM Assistant",
...
#     st.title("Your Personal AI GYM Assistant")
...
def render_live_progress_and_sync(context):
    """Refreshes sidebar metrics every second without disrupting the WebRTC stream."""
    if context:
        sync_metrics_update(context)
...
def main():
    ...
    if not workout_started:
        ...
        with st.sidebar:
            render_live_progress_and_sync(context)
